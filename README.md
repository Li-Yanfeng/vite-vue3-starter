...
一个 `vite2 + vue3 + typescript` 开箱即用现代开发模板
...
```shell
git clone git@gitee.com:li-yan-feng/vite-vue3-starter.git
```

### 新的 `Github` 仓库 👉 [Use this template](https://github.com/Li-Yanfeng/vite-vue3-starter/generate)
...
与 [vite-auto-import-resolvers](https://github.com/dishait/vite-auto-import-resolvers)

### [组件自动引入](https://github.com/antfu/unplugin-auto-import)
...
### [图标自动引入](https://github.com/antfu/unplugin-auto-import)
...
同时支持 [属性化模式](https://cn.windicss.org/features/attributify.html#attributify-mode)，即可以用简写。该功能默认关闭，可在 `windi.config.ts` 中
设置 `attributify` 为 `true` 开启
...
### [暗黑模式支持](https://cn.windicss.org/features/dark-mode.html#dark-mode)
...
### [pnpm 包管理器](https://pnpm.io/zh/)

`pnpm` 是非常优秀的包管理器，更快、更节省空间、更合理

具体可见 👉 [pnpm](https://pnpm.io/zh/)

### [跳转进度条支持](https://github.com/rstacruz/nprogress)
...
/** 省略其他样式 **/
#nprogress .bar {
    @apply bg-purple-700 bg-opacity-75;
    /** 配色 **/
...
### [Inspect 调试支持](https://github.com/antfu/vite-plugin-inspect)
...
### [Vitest 单元测试支持](https://vitest.dev/guide/#configuring-vitest)
...
### [支持 Markdown 渲染](https://github.com/antfu/vite-plugin-md)
...
### [i18n 国际化支持](https://github.com/intlify/bundle-tools/tree/main/packages/vite-plugin-vue-i18n)
...
### [`tsx` 支持](https://github.com/vitejs/vite/tree/main/packages/plugin-vue-jsx)
...
### [`gzip` 资源压缩支持](https://github.com/vbenjs/vite-plugin-compression)
...
# 感谢 [帝莎编程 / tov-template](https://gitee.com/dishait/tov-template) 的分享